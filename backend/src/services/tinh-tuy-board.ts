...
export const BOARD_CELLS: IBoardCell[] = [
  ...
  { index: 10, type: 'PROPERTY', name: 'tinhTuy.cells.benThanh', group: 'purple',
    price: 1400, rentBase: 100, rentGroup: 200, rentHouse: [500, 1500, 4500, 6250], rentHotel: 7500,
    houseCost: 1000, hotelCost: 1000, icon: 'ben-thanh.png' },
  ...
  { index: 17, type: 'PROPERTY', name: 'tinhTuy.cells.haLong', group: 'red',
  ...
  { index: 21, type: 'PROPERTY', name: 'tinhTuy.cells.cauVang', group: 'yellow',
    price: 2600, rentBase: 220, rentGroup: 440, rentHouse: [1100, 3300, 8000, 9750], rentHotel: 11500,
    houseCost: 1500, hotelCost: 1500, icon: 'cau-vang.png' },
  ...
  { index: 33, type: 'PROPERTY', name: 'tinhTuy.cells.conDao', group: 'dark_blue',
    price: 3500, rentBase: 350, rentGroup: 700, rentHouse: [1750, 5000, 11000, 13000], rentHotel: 15000,
...
export function getStationRent(stationsOwned: number): number {
