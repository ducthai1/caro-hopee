...
export const CHARACTER_ABILITIES: Record<TinhTuyCharacter, AbilityDisplayDef> = {
  ...
  horse: {
    ...
    active: { nameKey: 'tinhTuy.abilities.horse.active.name', descriptionKey: 'tinhTuy.abilities.horse.active.desc', icon: '💨', cooldown: 10, targetType: 'STEPS', phase: 'ROLL_DICE' },
